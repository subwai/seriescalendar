...
class Create extends MainView {
    ...
    <h1 class="pull-left">Create a new series entry</h1>
    ...
    <div class="panel panel-default clearfix series-create">
      ...
      <div class="panel-body">
        <form id="series-form" method="post" role="form">
          <div class="row">
            <div class="col-lg-12">
            <?php if ($this->Model->Error): ?>
              <div class="alert alert-danger alert-dismissable">
                <button type="button" class="close" data-dismiss="alert" aria-hidden="true">&times;</button>
                <strong>Error:</strong> <?= $this->Model->Error ?>
              </div>
            <?php endif ?>
            </div>
            <div class="col-lg-5">
              <div class="form-group description-group">
                ...
                <textarea name="Overview" class="form-control" rows="6"><?= $this->Model->Series->Overview ?></textarea>
              </div>
            </div>
            <div class="col-lg-7">
              <div class="form-group input-group-lg">
                <label for="SeriesName"><h4>Title <small>What the series is called.</small></h4></label>
                <input type="text" name="SeriesName" class="form-control input-group-lg" value="<?= $this->Model->Series->SeriesName ?>">
              </div>
              <div class="row">
                <div class="col-lg-6">
                  <div class="form-group release-time-group">
                    ...
                    <div class="input-group input-group-lg">
                      <input type="time" name="Airs_Time" placeholder="HH:mm AM/PM" class="form-control" value="<?= $this->Model->Series->Airs_Time ?>" />
                    </div>
                  </div>
                </div>
                <div class="col-lg-6">
                  <div class="form-group release-week-day-group">
                    ...
                    <div class="input-group input-group-lg">
                      <select name="Airs_DayOfWeek" class="form-control">
                        <option value="1" <?= $this->Model->Series->Airs_DayOfWeek == 1 ? "selected" : "" ?>>Monday</option>
                        <option value="2" <?= $this->Model->Series->Airs_DayOfWeek == 2 ? "selected" : "" ?>>Tuesday</option>
                        <option value="3" <?= $this->Model->Series->Airs_DayOfWeek == 3 ? "selected" : "" ?>>Wednesday</option>
                        <option value="4" <?= $this->Model->Series->Airs_DayOfWeek == 4 ? "selected" : "" ?>>Thursday</option>
                        <option value="5" <?= $this->Model->Series->Airs_DayOfWeek == 5 ? "selected" : "" ?>>Friday</option>
                        <option value="6" <?= $this->Model->Series->Airs_DayOfWeek == 6 ? "selected" : "" ?>>Saturday</option>
                        <option value="0" <?= $this->Model->Series->Airs_DayOfWeek == 0 ? "selected" : "" ?>>Sunday</option>
                      </select>
                    </div>
                  </div>
                </div>
